<template>
  <div class="section" id="o-nas">
    <h1 class="section__title">Kim Jesteśmy</h1>
    <v-layout row wrap class="about">
      <v-flex md12
...
blockquote {
  ...
  p:before, p:after {
    font-weight: bold;
    font-size: 70px;
    color: transparentize($darkRed, 0.4);
    position: absolute;
    font-family: 'Georgia';
  }
  p:before {
